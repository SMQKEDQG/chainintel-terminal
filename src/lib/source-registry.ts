...
export const DATA_SOURCES: DataSource[] = [
  // ─── MARKET DATA (12) ────────────────────────────────────
  { id: 'cmc-listings', name: 'CoinMarketCap Listings', category: 'Market Data', type: 'rest-api', description: 'Top 200 cryptocurrencies — price, volume, market cap, 24h/7d/30d changes', endpoint: '/v1/cryptocurrency/listings/latest', auth: 'free-key', refreshRate: '60s', tabs: ['Market', 'Overview'], status: 'active' },
  { id: 'cmc-quotes', name: 'CoinMarketCap Quotes', category: 'Market Data', type: 'rest-api', description: 'Real-time individual asset price quotes', endpoint: '/v2/cryptocurrency/quotes/latest', auth: 'free-key', refreshRate: '60s', tabs: ['Market'], status: 'active' },
  { id: 'cmc-global', name: 'CoinMarketCap Global Metrics', category: 'Market Data', type: 'rest-api', description: 'Total market cap, BTC dominance, 24h volume', endpoint: '/v1/global-metrics/quotes/latest', auth: 'free-key', refreshRate: '60s', tabs: ['Overview', 'Market'], status: 'active' },
  { id: 'cmc-trending', name: 'CoinMarketCap Trending', category: 'Market Data', type: 'rest-api', description: 'Trending tokens, gainers, losers', endpoint: '/v1/cryptocurrency/trending/latest', auth: 'free-key', refreshRate: '5m', tabs: ['Market'], status: 'active' },
  { id: 'cmc-categories', name: 'CoinMarketCap Categories', category: 'Market Data', type: 'rest-api', description: 'Sector performance — DeFi, L1, L2, Meme, AI, RWA', endpoint: '/v1/cryptocurrency/categories', auth: 'free-key', refreshRate: '5m', tabs: ['Market'], status: 'active' },
  { id: 'coingecko-markets', name: 'CoinGecko Markets', category: 'Market Data', type: 'rest-api', description: 'Market data for 14 ChainScore-rated assets', endpoint: '/api/v3/coins/markets', auth: 'none', refreshRate: '60s', tabs: ['ChainScore', 'Market'], status: 'active' },
  { id: 'coingecko-global', name: 'CoinGecko Global', category: 'Market Data', type: 'rest-api', description: 'Global DeFi market cap, total market stats', endpoint: '/api/v3/global', auth: 'none', refreshRate: '5m', tabs: ['Overview', 'DeFi'], status: 'active' },
